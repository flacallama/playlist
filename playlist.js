function readyFn(jQuery) {
  ...
  $(document).ready(function() {
    ...
    $.get('https://lit-fortress-6467.herokuapp.com/object', function(data) {
      ...
      // is the location of this block of code ok? It breaks when I move it outside of the on-load handler. Maybe there should be a more general GET?
